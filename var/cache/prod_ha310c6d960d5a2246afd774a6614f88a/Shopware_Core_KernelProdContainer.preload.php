...
(require __DIR__.'/Shopware_Core_KernelProdContainer.php')->set(\ContainerBj3d9te\Shopware_Core_KernelProdContainer::class, null);
...
$classes[] = 'TestPlugin\Storefront\Controller\ExampleController';
