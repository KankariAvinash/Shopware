...
class __TwigTemplate_bc1a9c66fb0e446cb36b8fcc37bf1a8c extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_base_flashbags($context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable(sw_get_attribute($this->env, $this->source, ($context["app"] ?? null), "flashes", [["warning", "error", "danger"]], "method", false, false, false, 5));
        $context['loop'] = [
...
";
    ...
    {
        return new Source("", "@Storefront/storefront/page/error/_page.html.twig", "/home/avinash/Desktop/work/Shopware/vendor/shopware/storefront/Resources/views/storefront/page/error/_page.html.twig");
    }
}
