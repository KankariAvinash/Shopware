...
$catalogue = new MessageCatalogue('en-GB', array (
  ...
  array (
    ...
    'general.privacyNotice' => 'By clicking continue you confirm that you have read our <a data-toggle="modal" data-bs-toggle="modal" data-url="%privacyUrl%" href="%privacyUrl%" title="Data protection information">data protection information</a> and have accepted our <a data-toggle="modal" data-bs-toggle="modal" data-url="%tosUrl%" href="%tosUrl%" title="general terms and conditions">general terms and conditions</a>.',
    ...
    'account.profileDelete' => '<a href="%target%" data-toggle="modal" data-bs-toggle="modal" data-target="%target%" data-bs-target="%target%">Click here</a> to delete all your personal data',
    ...
    'account.orderActionView' => 'Expand',
    'account.orderActionHide' => 'Collapse',
    ...
    'checkout.addPromotionLabel' => 'Discount code',
    'checkout.addPromotionPlaceholder' => 'Enter discount code...',
    ...
    'checkout.confirmRevocationNotice' => 'Please note our <a data-toggle="modal" data-bs-toggle="modal" data-url="%url%" href="%url%" title="Cancellation policy">cancellation policy</a>.',
    'checkout.confirmTerms' => 'I have read and accepted the <a data-toggle="modal" data-bs-toggle="modal" data-url="%url%" href="%url%" title="General terms and conditions">general terms and conditions</a>.',
    'checkout.confirmTermsText' => 'I have read and accepted the <a data-ajax-modal="true" data-url="%url%" href="%url%" title="general terms and conditions">general terms and conditions</a>.',
    'checkout.confirmTermsReminder' => '<br>You have already accepted the <a data-toggle="modal" data-bs-toggle="modal" data-url="%url%" href="%url%" title="General terms and conditions">general terms and conditions</a>.',
    ...
    'checkout.addToCartSuccess' => '{1} 1 product added to your shopping cart.|]1,Inf[ %count% products added to your shopping cart.',
    'checkout.shippingCosts' => 'Shipping details',
 ...
 To complete the sign-up process, search your inbox for our confirmation email and click on the link provided with it.',
    'newsletter.subscriptionPersistedInfo' => 'If you did not receive any email, please repeat the process or contact our support team.',
    ...
    'contact.privacyNotice' => 'By clicking continue you confirm that you have read and agree to our <a data-toggle="modal" data-bs-toggle="modal" data-url="%privacyUrl%" href="%privacyUrl%" title="Data protection information">data protection information</a>.',
    'contact.privacyNoticeText' => 'By selecting continue you confirm that you have read and agree to our <a data-ajax-modal="true" data-url="%privacyUrl%" href="%privacyUrl%" title="Data protection information">data protection information</a>.',
    ...
    'footer.serviceContactLink' => 'Or via our <a data-bs-toggle="modal" data-toggle="modal" data-url="%url%" href="%url%" title="contact form">contact form</a>.',
    ...
    'footer.includeVat' => '* All prices incl. VAT plus <a data-toggle="modal" data-bs-toggle="modal" href="%url%" data-url="%url%" title="Shipping details">shipping costs</a> and possible delivery charges, if not stated otherwise.',
    'footer.includeVatText' => '* All prices incl. VAT plus <a data-ajax-modal="true" href="%url%" data-url="%url%">shipping costs</a> and possible delivery charges, if not stated otherwise.',
    'footer.excludeVat' => '* All prices excl. VAT plus <a data-toggle="modal" data-bs-toggle="modal" href="%url%" data-url="%url%" title="Shipping details">shipping costs</a> and possible delivery charges, if not stated otherwise.',
    'footer.excludeVatText' => '* All prices excl. VAT plus <a data-ajax-modal="true" href="%url%" data-url="%url%">shipping costs</a> and possible delivery charges, if not stated otherwise.',
    ...
    'cookie.message' => 'This website uses cookies to ensure the best experience possible. <a data-toggle="modal" data-bs-toggle="modal" data-url="%url%" href="%url%" title="More information">More information...</a>',
    ...
    'component.cms.vimeo.privacyNotice' => 'By viewing the video you agree that your data will be transferred to %platform% and that you have read the <a data-toggle="modal" data-bs-toggle="modal" data-url="%url%" href="%url%" title="Privacy policy">Privacy policy</a>.',
